...
class RMCharacterEpisodeCollectionViewCell: UICollectionViewCell {
    ...
    private func setUpConstraints() {
        NSLayoutConstraint.activate([
            ...
            seasonLabel.heightAnchor.constraint(equalTo: contentView.heightAnchor, multiplier: 1/3),
            ...
            dateLabel.heightAnchor.constraint(equalTo: contentView.heightAnchor, multiplier: 1/3),
        ])
    }
